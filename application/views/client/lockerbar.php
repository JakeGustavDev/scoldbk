...
<div id="accordion_locker">
	...
	<?php
		$day=date('N'); if ($user['special']==0&&$user['courtesye']==0&&$cover>0) {
	?>
	...
	?>
		...
		<table id="tableborderfine_1" aling="center" border="1"  width="300px"> <!-- Tabla productos -->
			<tr>
				<td>
					<p id="l6">Cortesía</p>
				</td>
	...
	<div border="0" id="lateral" align="center">
		<div style="display: block;">
			<?php if ($day==1) { ?>
				...
				<!-- <a href="javascript:confirm3('index.php?/bar/giveDrink?locker=<?php echo $user['number']; ?>&type=46','POPPER')">
					<div id="btnbar" align="center">
						<p id="l6">POPPER</p>
					</div>
				</a> -->				
			<?php }elseif($day==2){ ?>
				...
				<a href="javascript:confirm3('index.php?/bar/giveDrink?locker=<?php echo $user['number']; ?>&type=33','TEQUILA DE LA CASA')">
					<div id="btnbar" align="center">
						<p id="l6">TEQUILA<br>CASA<br>DESC.</p>
					</div>
				</a>
				<a href="javascript:confirm3('index.php?/bar/giveDrink?locker=<?php echo $user['number']; ?>&type=9','TEQUILA DOBLE')">
					<div id="btnbar" align="center">
				...
				</a><a href="javascript:confirm3('index.php?/bar/giveDrink?locker=<?php echo $user['number']; ?>&type=43','CAJETILLA GRANDE')">
					<div id="btnbar" align="center">
						<p id="l6">CAJETI<br>GRANDE</p>
					</div>
				</a>
			...
			<?php }elseif ($day==3) { ?>
				...
				<a href="javascript:confirm3('index.php?/bar/giveDrink?locker=<?php echo $user['number']; ?>&type=10','TEQUILA DESCUENTO')">
					<div id="btnbar" align="center">
						<p id="l6">TEQUILA<br>DESC.</p>
					</div>
				</a>
				<a href="javascript:confirm3('index.php?/bar/giveDrink?locker=<?php echo $user['number']; ?>&type=38','TEQUILA JOSE CUERVO')">
					<div id="btnbar" align="center">
				...
				<a href="javascript:confirm3('index.php?/bar/giveDrink?locker=<?php echo $user['number']; ?>&type=2','VODKA DESCUENTO')">
					<div id="btnbar" align="center">
						<p id="l6">VODKA<br>DESC.</p>
					</div>
				</a>
				<a href="javascript:confirm3('index.php?/bar/giveDrink?locker=<?php echo $user['number']; ?>&type=36','VODKA FINLANDIA')">
				<div id="btnbar" align="center">
				...
				<a href="javascript:confirm3('index.php?/bar/giveDrink?locker=<?php echo $user['number']; ?>&type=21','COCKTAIL DESCUENTO')">
					<div id="btnbar" align="center">
						<p id="l6">COCKTAIL<br>SCANDI<br>DESC.</p>
					</div>
				</a>
				<a href="javascript:confirm3('index.php?/bar/giveDrink?locker=<?php echo $user['number']; ?>&type=47','MICHELADA')">
					<div id="btnbar" align="center">
				...
				<a href="javascript:confirm3('index.php?/bar/giveDrink?locker=<?php echo $user['number']; ?>&type=5','RON DESCUENTO')">
					<div id="btnbar" align="center">
						<p id="l6">RON <br> DESC.</p>
					</div>
				</a>
				<a href="javascript:confirm3('index.php?/bar/giveDrink?locker=<?php echo $user['number']; ?>&type=4','RON DOBLE')">
					<div id="btnbar" align="center">
