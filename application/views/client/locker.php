													...
													<td>
														<div id="l4">
															...
															$consumption = array(
																...
																array(29, $user['stela1'] * 1),
																array(30, $user['regia'] * 1),
																array(28, $user['michelob'] * 1),
																array(28, $user['michelob1'] * 1),
																array(31, $user['cabro'] * 1),
																array(31, $user['cabro1'] * 1),
												...
												<tr valing="top">
													<td>
														<table id="tableborderfine_1" aling="center" border="1" width="245px">
															...
															<tr>
																<td>
																	<p id="l6">Dep Axilas</p>
																</td>
																<td align="center">
																	<p id="l6"><?php echo $user['depaxilas']; ?></p>
																</td>
															</tr>
															<tr>
																<td>
																	<p id="l6">Dep Brazos</p>
																</td>
																<td align="center">
																	<p id="l6"><?php echo $user['depbrazos']; ?></p>
																</td>
															</tr>
															<tr>
																<td>
																...
																<td align="center">
																	<p id="l6"><?php echo $user['depnariz']; ?></p>
																</td>
															</tr>
															<tr>
																<td>
																...
																<td align="center">
																	<p id="l6"><?php echo $user['deppecho']; ?></p>
																</td>
															</tr>
															<tr>
																<td>
																	<p id="l6">Dep Pecho y Abdomen</p>
																</td>
																<td align="center">
																	<p id="l6"><?php echo $user['deppechoabdomen']; ?></p>
																</td>
															</tr>
															<tr>
																<td>
																	<p id="l6">Dep Ano y Gluteos</p>
																</td>
																<td align="center">
																	<p id="l6"><?php echo $user['depanogluteos']; ?></p>
																</td>
															</tr>
															<tr>
																<td>
																	<p id="l6">Dep Parte Intima</p>
																</td>
																<td align="center">
																	<p id="l6"><?php echo $user['depparteintima']; ?></p>
																</td>
															</tr>
															<tr>
																<td>
																	<p id="l6">Dep Espalda</p>
																</td>
																<td align="center">
																	<p id="l6"><?php echo $user['depespalda']; ?></p>
																</td>
															</tr>
															<tr>
																<td>
																	<p id="l6">Dep Piernas Completas</p>
																</td>
																<td align="center">
																	<p id="l6"><?php echo $user['deppiernas']; ?></p>
																</td>
															</tr>
															<tr>
																<td>
																	<p id="l6">Dep Pantorrilla o Muslo</p>
																</td>
																<td align="center">
																	<p id="l6"><?php echo $user['deppanomuslo']; ?></p>
																</td>
															</tr>
															<tr>
																<td>
																	<p id="l6">Facial Scandinavia</p>
																</td>
																<td align="center">
																	<p id="l6"><?php echo $user['facialscan']; ?></p>
																</td>
															</tr>
															<tr>
																<td>
																	<p id="l6">Facil Profundo</p>
																</td>
																<td align="center">
																	<p id="l6"><?php echo $user['facialprof']; ?></p>
																</td>
															</tr>
															<tr>
																<td>
																...
																<td align="center">
																	<p id="l6"><?php echo $user['bañador']; ?></p>
																</td>
															</tr>
															<tr>
																<td>
																	<p id="l6">Ropa Interior +</p>
																</td>
																<td align="center">
																	<p id="l6"><?php echo $user['ropapm']; ?></p>
																</td>
															</tr>
															<tr>
																<td>
															...
															<tr>
																...
																<td align="center">
																	<p id="l6"><?php echo $user['suspensor']; ?></p>
																</td>
															</tr>
															<tr>
																<td>
															...
															<tr>
																...
																<td align="center">
																	<p id="l6"><?php echo $user['pulseras']; ?></p>
																</td>
															</tr>
															<tr>
																<td>
															...
															<tr>
																...
																<td align="center">
																	<p id="l6"><?php echo $user['acc1']; ?></p>
																</td>
															</tr>
															<tr>
																<td>
																	<p id="l6">Accesorio 1</p>
																</td>
																<td align="center">
																	<p id="l6"><?php echo $user['acc2']; ?></p>
																</td>
															</tr>
															<tr>
																<td>
																	<p id="l6">Accesorio 2</p>
																</td>
																<td align="center">
																	<p id="l6"><?php echo $user['acc3']; ?></p>
																</td>
															</tr>
															<tr>
																<td>
